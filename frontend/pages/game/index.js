$(document).ready(function () {
 ...
 /*  const url = {
  ...
  function validateTheMove(board_positions, move, direction) {
        ...
        if (submittedDirection === "row") {
          ...
          if ( validateTheMove(submitedLetters[2].boardId,firstMove, submittedDirection) ) {
            ...
            if (gaps.length === 0) {
              ...
              //write an asyncronous function to handle the requisition 
             /*  wordCheck(draft); */
            }
          }
        } else {
